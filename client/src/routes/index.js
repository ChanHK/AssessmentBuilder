  ...
  return (
    <Router>
      <Switch>
        ...
        />
        <Route
          path="/assessment/descriptive/responses/:assessmentID/:subject"
          exact
        ...
        />
        <Route
          path="/assessment/statistics/:assessmentID/:subject"
          exact
        ...
        />
        <Route
          path="/assessment/activation/:subject/:assessmentID"
          exact
        ...
        />
        <Route
          path="/assessment/:type(edit|create|view)/:selected(settings|questions|set|access|timer)/:assessmentID/:subject"
          exact
        ...
        />
        <Route
          path="/assessment/attempt/:timeSettings(1|2|3)/:totalSec/:assessmentID"
          exact
